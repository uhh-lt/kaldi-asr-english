...
wget --continue http://kaldi-asr.org/models/5/4gram_small.arpa.gz -P data/local/local_lm.tedlium/data/arpa || exit 1
wget --continue http://kaldi-asr.org/models/5/4gram_big.arpa.gz -P data/local/local_lm.tedlium/data/arpa || exit 1
