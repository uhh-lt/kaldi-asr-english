...
model_name=en_200k_nnet3chain_tdnn1f_2048_sp_bi
...
sed -i 's#exp/nnet3_cleaned/ivectors_train_cleaned_sp_hires/conf/#models/'"$model_name"'/ivector_extractor/#g' $model_name/ivector_extractor/ivector_extractor.conf
